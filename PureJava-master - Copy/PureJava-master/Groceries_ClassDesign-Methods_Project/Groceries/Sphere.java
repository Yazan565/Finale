public class Sphere extends ShoppingCart {
  ...
  return "Boxing Guide: \nNumber Ordered: " + this.numberOrdered + "\n" +
         ...
         " full row(s) on last flat, " + this.sphereLeftover + texttype();


}

   public String texttype(){
     if(this.diameter == Information.orangeDiameter){
       return " oranges in last row";
     }
     else if(this.diameter == Information.appleDiameter) {
     return " apples in last row";
     }
     else {
       return " chocolates in last row";
